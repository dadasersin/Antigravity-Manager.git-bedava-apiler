// File: src/components/stats/RequestHealthCards.tsx
...
export const RequestHealthCards = memo(({ 
    ...
    // Use fallback if stats (logs) are empty but we have token usage history
    ...
    // Default configuration (Log Data Available)
    let card2 = {
    ...
    // Fallback configuration (No Logs, Token Usage available)
    if (hasFallbackData) {
        card2 = {
